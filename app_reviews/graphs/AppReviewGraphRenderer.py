...
class AppReviewGraphRenderer:
    ...
    def drawRatingHistogram(self):
        # Histogram function to depict ratings
    ...
    def drawBehavorialEmotionalChart(self):
        # Summing up reviews to find behavioral and emotional traits
        review_summation = ""
        ...
        # Finding iptc, behavioral, emotional traits from summated text
